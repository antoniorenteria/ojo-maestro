...
function mezclar(a, b) {
  ...
  ['personal', 'productos', 'sucursales', 'insumos', 'recetas', 'finCategorias', 'finCuentas', 'finMovimientos', 'finMetas', 'finPresupuesto'].forEach(function (k) {
    var mapa = {};
  ...
  // banderas de siembra: si algun lado ya sembro, no re-sembrar
