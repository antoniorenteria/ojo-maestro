...
function mezclar(a, b) {
  ...
  ['turnos', 'cierres', 'checklists', 'evidencias', 'eventos', 'propinas', 'tareas', 'revisiones', 'preparaciones', 'calendario', 'gastos', 'tripulacion', 'tripCapac', 'tripAuditoria', 'calEventos'].forEach(function (k) {
    var mapa = {};
