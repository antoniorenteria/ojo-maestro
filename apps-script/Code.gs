...
function mezclar(a, b) {
  ...
  ['turnos', 'cierres', 'checklists', 'evidencias', 'eventos', 'propinas', 'tareas', 'revisiones', 'preparaciones', 'calendario', 'gastos', 'tripulacion', 'tripCapac', 'tripAuditoria'].forEach(function (k) {
    var mapa = {};
