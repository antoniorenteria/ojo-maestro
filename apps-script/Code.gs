...
function mezclar(a, b) {
  ...
  ['turnos', 'cierres', 'checklists', 'evidencias', 'eventos', 'propinas', 'tareas', 'revisiones', 'preparaciones', 'calendario', 'gastos', 'tripulacion', 'tripCapac', 'tripAuditoria', 'calEventos', 'objetivos', 'avisos', 'dirTareas'].forEach(function (k) {
    var mapa = {};
